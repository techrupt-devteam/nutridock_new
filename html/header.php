...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <meta property="og:title" content="Order | Nutridock">
    <meta property="og:url" content="https://www.nutridock.com/">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Nutridock">
        
    <link rel="canonical" href="https://www.nutridock.com/">
       
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.png" sizes="16x16"> 

    <script src="assets/js/jquery-3.js" type="text/javascript"></script>    
    <link rel="stylesheet" href="assets/fontawesome/css/all.min.css" type="text/css">
    <link rel="stylesheet" href="assets/css/bootstrap.css" type="text/css">
    <!-- <link rel="stylesheet" href="assets/css/mdb.css" type="text/css"> -->
    <!-- <link rel="stylesheet" href="assets/css/swiper.css" type="text/css">
 -->    <link rel="stylesheet" href="assets/css/style.css" type="text/css">
    <link rel="stylesheet" href="assets/css/style-new.css" type="text/css"> 

    <!-- <script src="assets/js/crypto.js" type="text/javascript"></script>    
    <script src="assets/js/Encryption.js" type="text/javascript"></script>     -->
...
<header id="header-main" class="header darkblue">
    <div class="container-fluid">
        <div class="row">
         <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 header-top-col colorcodeclass">
            <div class="phone-left">              
                <a class="colorcodeclass" href="tel:7447725922">
                    <span class="svg-icon">
                        <i class="fas fa-phone-alt"></i>
                    </span>
                    <span class="phoneno colorcodeclass">+91 7447725922</span>
                </a>
            </div>
            <div class="social-buttons">
                <a class="colorcodeclass" href="https://www.facebook.com/" target="_blank"> <i class="fab fa-facebook"></i> </a>
                <a class="colorcodeclass" href="https://www.instagram.com/" target="_blank"> <i class="fab fa-instagram-square"></i> </a> 
            </div>
             
            </div>            
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 header-col">
            <div class="header-left">
                <div class="logo-img float-left">
                  <a class="navbar-brand logolink" href="javascript:void(0);">
                        <img src="assets//images/logo.png" class="img-fluid" alt="logo logo-mobile">                    
                 </a>
                </div>
                ...
                <div class="float-left order-0 sign-up d-sm-none">
                ...
                <div class="header-right float-right">
                                ...
                                <div class="col-9">
                                    <div class="input-group search-input">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <button class="btn btn-search hidden clear_search_bar colorcodeclass waves-effect waves-light" type="submit"><i class="fa fa-close"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="head-min-ord float-left order-3">
                       <a data-toggle="modal" data-target="#myModal" style="align-self: center;cursor: pointer;"> 
                            <img src="assets/images/filter-setting.svg" width="25px" />
                        </a>
                    </div>
