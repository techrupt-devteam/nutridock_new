                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" autocomplete="off" class="form-control" id="menu_price" name="menu_price" placeholder="Enter Menu Price" required="true" data-parsley-errors-container="#price_error" data-parsley-error-message="Please enter price.">
