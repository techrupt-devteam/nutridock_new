                 ...
                 <div class="row">
                   <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{$data['name']}}" placeholder="Banner Name" required="true">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="oldpassword">File Upload<span style="color:red;" >*</span></label>
                        <div class="input-group">
                           ...
                           <span class="input-group-addon"> <a class="fancybox" rel="group" href="{{url('/')}}/uploads/banner/{{$data['image']}}"><i class="fa fa-eye"></i></a></span>
                        </div>
                    </div>
                  </div>
                 </div>
