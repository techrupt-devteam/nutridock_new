        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{url('/admin')}}/add_{{$url_slug}}" class="btn btn-primary btn-sm" style="float: right;">Add Store</a>
            </div>
            <!-- /.box-header -->
  ...
  <script type="text/javascript">
    ...
    {  
      ...
      swal({
        ...
        text: "Are You sure to change testimonial status",
        icon: "warning",
          buttons: [
            'Cancel',
            'Yes, change it!'
          ...
          { 
            ...
            //alert(status);
             $.ajax({
                  url: "{{url('/admin')}}/status_testimonial",
                  type: 'post',
                  data: {status:status,plan_ids:plan_id},
                  success: function (data) 
                  {
                    swal("Success", "Testimonial status successfully changed !", "success");
                  }
              });
