        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{url('/admin')}}/add_{{$url_slug}}" class="btn btn-primary btn-sm" style="float: right;">Add Blog Category</a>
            </div>
            <!-- /.box-header -->
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> 
  ...
  <script type="text/javascript">
    ...
    {  
      ...
      swal({
        title: "Blog category status",
        text: "Are You sure to change Blog category status",
        icon: "warning",
          buttons: [
            'Cancel',
            'Yes, change it!'
          ...
          { 
            ...
            //alert(status);
             $.ajax({
                  url: "{{url('/admin')}}/status_blogcategory",
                  type: 'post',
                  data: {status:status,plan_ids:plan_id},
                  success: function (data) 
                  {
                    swal("Success", "Blog category status successfully changed !", "success");
                  }
              });
