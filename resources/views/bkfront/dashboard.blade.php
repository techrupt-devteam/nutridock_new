          ...
          <!-- @include('layouts.bread_crum') -->
           <div class="row">
            ...
            <div class="alert-message alert-message-danger">
                <h4>
                    Alert Subscription Expire</h4>
                <p>
                   Dear subscriber your <b> Nutridock Fit</b> meal plan subscription expire.<strong> Renew subscription link <i class="glyphicon glyphicon-hand-right"></i> <a href="{{ url('/')}}/purchase_new_subscription"  style="color: #ffff !important; font-weight:600" class="btn-sm btn-danger btn"id="blink1">
