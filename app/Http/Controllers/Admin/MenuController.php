...
{
    public function __construct(MealType $MealType,MenuModel $MenuModel,MenuCategoryModel $MenuCategoryModel,IngredientsModel $IngredientsModel,SpecificationModel $SpecificationModel,Notification $Notification,Kitchen $Kitchen)
    {
        $data                            = [];
    ...
    public function add()
    {
        ...
        $kitchen           = $this->base_kitchen->orderby('kitchen_id','DESC')->where('is_active','=',1)->get();
        $data['page_name'] = "Add";
